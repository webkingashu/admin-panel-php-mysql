...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_LOGIN_PAGE', 'index.php'); //the url to the login page
	...
	//FILESYSTEM CONFIG
		...
		*/
	define(
		'CONFIG_WEBSITE_DOCUMENT_ROOT', 
		str_replace(
			'\\',
			'/',
			preg_replace('#admin.*#', '', realpath(dirname(__FILE__)))
		)
	);
	
		
	define('CONFIG_SYS_DEFAULT_PATH', CONFIG_WEBSITE_DOCUMENT_ROOT . 'userfiles/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', CONFIG_WEBSITE_DOCUMENT_ROOT . 'userfiles/');	//accept relative path only
	...
	define('CONFIG_DEFAULT_PAGINATION_LIMIT', 50);
